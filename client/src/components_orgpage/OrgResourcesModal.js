        ...
        <Row>
          <Col xs={12}>
            <Form>
              ...
              <Form.Group
                controlId="resourceLink"
                bssize="large"
                style={{ marginTop: 5 }}
              >
                <Form.Control
                  placeholder="Resource link (https://www.example.com) "
                  value={fields.resourceLink}
                  onChange={handleFieldChange}
                />
              </Form.Group>
              <Button
          ...
          <Col xs={12}>
            <Modal.Title style={{ fontSize: 22, marginTop: 20 }}>
              Current Resources
            </Modal.Title>
            <p id="requestCall" style={{ marginTop: -15, marginBottom: 15 }}>
              &nbsp;
            </p>
            {props.association.links ? (
              props.association.links.map((resource, i) => {
                return (
                  <>
                    <a
                      target="_blank"
