...
export default function OrganizationBeaconModal(props) {
  ...
  const setVolunteers = (volunteers) => {
    ...
    setUnacceptedVolunteers(
      volunteers.filter((volunteer) => !volunteer.response)
    );
  };
        ...
        return (
          <Row>
            ...
            <Col md={6} style={{ paddingRight: 15, paddingLeft: 4 }}>
              <Button id="large-button-empty" onClick={showCompleteBeacon}>
                Complete Beacon
              </Button>
            </Col>
          </Row>
    ...
    <>
      ...
      >
        ...
        <Modal.Body>
          <Row>
            <Col>
              <h5 id="volunteer-name" style={{ marginTop: 0, marginBottom: 5 }}>
                Your message:
              </h5>
                      ...
                      <ListGroup.Item key={i}>
                        <div>
                          <h5 id="volunteer-name">
                            {volunteer.volunteer_first}{" "}
                            {volunteer.volunteer_last}
                          </h5>
                          <Badge
                          ...
                          volunteer.responseMessage.length > 0 ? (
                            <p
                              id="regular-text"
          ...
          <Row style={{ marginTop: 15 }}>
            <Col>
              <Button id="large-button" onClick={showAcceptedVolunteersModal}>
                View Accepted Volunteers
              </Button>
            </Col>
          </Row>
