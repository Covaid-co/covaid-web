    ...
    if (justRegistered) {
        return (
            <Modal show={props.showModal} onHide={props.hideModal}>
                ...
                <Modal.Body>
                    <p id="regular-text">
                        We'll be in contact with you shortly about the details of your organization portal!
                    </p>
                </Modal.Body>
            </Modal>
        )
			...
			<Modal.Body>
				...
				<Form onSubmit={props.handleHide} style={{marginTop: 0, marginBottom: 10, display: "block", whiteSpace: 'nowrap'}}>
                    ...
                    <Form.Group controlId="org_contact" bssize="large">
                        <FormControl value={fields.org_contact} onChange={handleFieldChange} placeholder="Organization Contact" style={{marginBottom: 5}}/>
                    </Form.Group>
                    <Form.Group controlId="org_details" bssize="large">
                        <FormControl value={fields.org_details} onChange={handleFieldChange} as="textarea" rows="5" placeholder="Details/Additional Info"/>
                    </Form.Group>
					<Button type="submit" id="large-button" style={{marginTop: 15}} onClick={handleSubmit}>Get Started</Button>
				</Form>
			</Modal.Body>
