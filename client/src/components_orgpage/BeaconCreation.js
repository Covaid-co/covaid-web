...
export default function BeaconCreation(props) {
  ...
  const findVolunteers = () => {
    ...
    if (requiredTasks.length === 0) {
      ...
      props.volunteers.forEach(function (volunteer) {
    ...
    props.volunteers.forEach(function (volunteer) {
      ...
      if (
        volunteer_tasks.some((task) => requiredTasks.includes(task)) &&
        volunteer.preVerified &&
  ...
  function resetState() {
    setTimeout(function () {
      setSelectedTasks(
        props.association
          ? setFalseObj(props.association.resources)
          : setFalseObj(defaultResources)
      );
      setCar(false);
      setPageNum(1);
    }, 1000);
          ...
          <Modal.Body style={{ paddingTop: 0 }}>
            <div id="page1">
              <Col xs="12">
                ...
                >
                  Beacons are a way for you to reach out to your volunteers in
                  mass. Use the filters below and we'll curate the most optimal
                  volunteers to get this done
                </p>
                <h5
                          ...
                          <Row>
                            <Col lg={1} md={1}>
                              <Form.Check
                                ...
                                onChange={() =>
                                  handleCheckboxAction(volunteer._id)
                                }
                                style={{ marginTop: 5 }}
                                id="default-checkbox"
                              />
          ...
          <Modal.Body style={{ paddingTop: 0 }}>
            <div id="page2">
              ...
              <Row>
                <Col>
                  <h5
                    ...
                    style={{ marginTop: 10, marginBottom: 10 }}
                  >
                    Choose the duration of this beacon
                  </h5>
              ...
              <Button
                ...
                onClick={() => sendBeacon()}
              >
                {isSending ? spinnerComponent : "Send your beacon"}
              </Button>
            </div>
          </Modal.Body>
          <VolunteerDetails
