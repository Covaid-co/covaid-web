    ...
    <div className="App">
      ...
      <Container style={{ maxWidth: 2500, marginBottom: 100 }}>
        <Row>
          ...
          <Col md={6} id="login-container" style={{marginTop: 100, paddingRight: 100}}>
            <embed height="250px" width="100%" src="https://www.gofundme.com/mvc.php?route=widgets/mediawidget&fund=25wj3-covaid&coinfo=1" type="text/html"></embed>
          </Col>
        </Row>
      </Container>
      <Footer key="2"/>
