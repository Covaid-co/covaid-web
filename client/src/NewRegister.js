...
export default function NewRegister(props) {
  ...
  const newHandleSubmit = async (e) => {
    ...
    var associationID =
      Object.keys(props.state.currentAssoc).length !== 0
        ? props.state.currentAssoc["_id"]
        ...
        >
          ...
          <Modal.Body>
            <p id="regular-text" style={{ marginBottom: 5 }}>
              Creating an account allows you to be listed as a volunteer in your
              area. Once logged in, you will be able to update your availability
              and indicate what you are offering.
            </p>
            <p
              id="regular-text"
              ...
              <Col xs={12}>
                <Form.Group controlId="pronouns" bssize="large">
                  <Form.Control
                    ...
                    onChange={handleFieldChange}
                    placeholder="Preferred Pronouns (Optional)"
                  />
                </Form.Group>
              </Col>
              <Col xs={12}>
      ...
      return (
        ...
        >
          ...
          <Modal.Body>
            ...
            <h5
              id="regular-text-bold"
              style={{ marginTop: "24px", marginBottom: 5 }}
            >
              What is your general availability?
            </h5>
            <CheckForm
              obj={availabilityChecked}
              setObj={setAvailabilityChecked}
            />
            <Details
          ...
          <Modal.Body>
            <Form onSubmit={newHandleSubmit}>
              ...
              <p id="regular-text" style={{ marginBottom: 4, fontSize: 14 }}>
                If they seem unfamiliar, please change your location from the
                home page.
              </p>
              <CheckForm
              ...
              {props.state.associations.length > 0 ? (
                <>
                  <h5
                    ...
                    style={{ marginTop: "24px", marginBottom: 5 }}
                  >
                    Local organizations help match volunteers with neighbors in
                    need
                  </h5>
                  <p
                    id="regular-text"
                  ...
                  >
                    Choose a nearby supporting organization to help manage your
                    mutual aid efforts.
                  </p>
                  <SelectionForm
                    associations={props.state.associations}
                    setState={props.setState}
                    currentAssoc={props.state.currentAssoc}
                  />
                </>
              ) : (
                <></>
              ...
              <p id="regular-text" style={{ marginBottom: 20, fontSize: 14 }}>
                For the your safety and the safety of all community members,
                please check the boxes to complete the volunteer pledge. If you
                have any questions about any of the choices, do not fill out the
                form and contact us at covaidco@gmail.com.
              </p>
              <Row>
                <Col md={12}>
                  {terms.map((term) => {
