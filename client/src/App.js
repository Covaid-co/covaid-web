...
>>>>>>> origin/translation
    ...
    const registerPage = (props, org) => {
        ...
        return <RegisterPage { ...props } setSwithToLanguage={setSwithToLang}
                            switchToLanguage={switchToLang}
                            org={org} locationProps={locationProps} isLoaded={isLoaded}
    ...
    const requestPage = (props, org) => {
        ...
        return <RequestPage { ...props } setSwithToLanguage={setSwithToLang} switchToLanguage={switchToLang}
                            org={org} locationProps={locationProps} isLoaded={isLoaded}
                            onLocationSubmit={onLocationSubmit} refreshLocation={refreshLocation}/>
    }
    ...
    const volunteerPage = (props) => {
        return <VolunteerPortal  { ...props }
                        setSwithToLanguage={setSwithToLang}
                        switchToLanguage={switchToLang}/>
    }

    const orgPage = (props) => {
        return <OrganizationPortal  { ...props }
                        setSwithToLanguage={setSwithToLang}
                        switchToLanguage={switchToLang}/>
    }
<<<<<<< HEAD
