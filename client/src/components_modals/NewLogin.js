        ...
        return (
            <Modal size='sm' show={props.showModal} onHide={props.hideModal} style={{marginTop: 110}}>
                <Modal.Header closeButton>
                    <Modal.Title>{translatedStrings[language].VolunteerLogin}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Button id="large-button-empty" onClick={() => {setMode(!mode);}}>{translatedStrings[language].ResetPassword}</Button>
                    </Form>
                </Modal.Body>
            </Modal>
        )
