...
export default function AboutUs(props) {
    return (
        <Modal show={props.showModal} style={{marginTop: 60}} onHide={props.hideModal}>
            ...
            <Modal.Body>
                <p id="regular-text">We're a group of college student/recent grads who want to play our part in the fight against COVID-19. Inspired by acts of mutual aid in our community, we created<strong><font id="home" style={{fontSize: 18}}> covaid</font></strong>
