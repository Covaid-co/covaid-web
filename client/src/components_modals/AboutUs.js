...
export default function AboutUs(props) {
  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        <p id="regular-text">{translatedStrings[language].AboutUs_Text1}</p>
        <p id="regular-text">
          {translatedStrings[language].AboutUs_Text2}
          <strong>
        ...
        <p id="regular-text">
          <strong>{translatedStrings[language].AboutUs_Question}</strong>{" "}
          {translatedStrings[language].AboutUs_Email} covaidco@gmail.com
        </p>
      </Modal.Body>
    </Modal>
  );
