    ...
    return (
        <Modal show={props.showModal} size="lg" style={{marginTop: 10}} onHide={props.hideModal}>
            <Modal.Header closeButton>
                <Modal.Title>{props.mobile ? 'Covaid Map' : 'Covaid Volunteer Map'} <Badge id='volunteerBadge'>{props.totalVolunteers} {translatedStrings[language].Volunteer}</Badge></Modal.Title>
            </Modal.Header>
            <Modal.Body>
