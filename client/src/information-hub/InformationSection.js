                                ...
                                <Container id="link-container">
                                    ...
                                    {(() => {
                                        if(resource.name.length < 21) {
                                            return (
                                                <div id="link-description-box1"><p id="link-description">{resource.description}</p></div>
                                            )
                                        } else {
                                            return (
                                                <div id="link-description-box2"><p id="link-description">{resource.description}</p></div>
                                            )
                                        }
                                    }) ()}
                                </Container>
