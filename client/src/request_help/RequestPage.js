...
export default function RequestPage(props) {
    ...
    const requestFormInfo = () => {
        var topHeader = <DefaultHeader setSwithToLanguage={props.setSwithToLanguage} switchToLanguage={props.switchToLanguage} 
                                       requestHeaderText={generalRequestText} translations={translatedStrings} language={language} changeLanguage={changeLanguage}/>;
        if (props.locationProps.currentAssoc && Object.keys(props.locationProps.currentAssoc).length > 0) {
            topHeader = <OrgHeader setSwithToLanguage={props.setSwithToLanguage} switchToLanguage={props.switchToLanguage} 
                                   assoc={props.locationProps.currentAssoc} translations={translatedStrings} language={language} changeLanguage={changeLanguage} />;
        }
        return (
            <>
                {topHeader}
    ...
    if (completed) {
        return ([
            <div className="App" key="1">
                <NavBar setSwithToLanguage={props.setSwithToLanguage} switchToLanguage={props.switchToLanguage} isLoggedIn={false} totalVolunteers={0} orgPortal={true}/>
