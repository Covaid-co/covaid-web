...
export default function RequestHelp(props) {
  ...
  const requestFormInfo = () => {
    ...
    return (
      <>
        {topHeader}
        <CurrentLocation
          locationProps={{ locality: props.locality, zipcode: props.zipcode }}
          showModal={() => {
            props.showModalType("location-request");
          }}
        />
  ...
  var assoc_id =
    props.currentAssoc._id && props.currentAssoc._id.length > 0
      ? props.currentAssoc._id
