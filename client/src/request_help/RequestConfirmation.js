    ...
    <Row style={{marginTop: 20}}>
      ...
      <Col sm={12} md={12} lg={8}>
        ...
        <div style={{ marginTop: 20 }}>
          <h5 id="subtitle-light" style={{ marginTop: 0, marginBottom: 5, display: 'inline' }}>
            Languages: 
          </h5>
          <p id="regular-text" style={{ marginBottom: 5, display: 'inline', marginLeft: 5 }}>{props.first_page.languages.join(", ")}</p>
        </div>
        ...
        <div style={{ marginTop: 15 }}>
          <h5 id="subtitle-light" style={{ marginTop: 10, marginBottom: 5, display: 'inline' }}>
            Needed by:
          </h5>
          <p id="regular-text" style={{ marginBottom: 5, display: 'inline', marginLeft: 5 }}>
