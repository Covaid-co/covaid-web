...
/**
 * Create a request and handle any required interactions
 */
exports.handleCreateRequest = asyncWrapper(async (req, res) => {
...
/**
 * Update request information given an _id and updates
 */
exports.handleUpdateRequest = asyncWrapper(async (req, res) => {
    const { body: { _id, updates } } = req;
	try {
		await RequestService.updateGeneralRequestInfo(_id, updates);
...
/**
 * Update status of a request given an _id and updates
 */
exports.handleUpdateRequestStatus = asyncWrapper(async (req, res) => {
    const { body: { _id, updates } } = req;
	try {
		await RequestService.updateRequestStatusInfo(_id, updates);
		return res.sendStatus(200);
	} catch (e) {
        console.log(e);
		return res.sendStatus(400);
