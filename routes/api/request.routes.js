...
// Create a request
router.post('/create', request_controller.handleCreateRequest);

// Get requests given a query
router.get('/', request_controller.handleGetRequests);

// Update request information
router.put('/update', request_controller.handleUpdateRequest);
router.put('/updatestatus', request_controller.handleUpdateRequestStatus);
